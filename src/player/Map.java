		...
		for (int i = 0; i < maxMapSize; i++)
		{
			...
			{				
				...
				if (mapCoordinates .contentEquals("0,0"))
					...
					mapUnitDescription = "You are standing in an open field. To the north, you hear the rushing of water, perhaps from a creek or small river.\n"
							+ "To the east, you see a heavily wooded forest, scarcely lit by the sun above.\n"
							+ "To the south, scattered patches of wildflowers decorate the otherwise drab field of tall grass.\n"
							+ "To the west stands a small house, long vacant, with boarded windows and doors.\n";
				else if (mapCoordinates .contentEquals("5,6"))
					mapUnitDescription =  "You are standing at the edge of a densely-wooded forest. You can"
							+ " hear the chattering of birds from beneath the canopy of trees.";
					//"Sixth Column, 4th Row from Top";
